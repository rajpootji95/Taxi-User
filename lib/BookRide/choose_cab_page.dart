...
import 'package:why_taxi_user/Model/promo_code.dart';
...
import 'package:why_taxi_user/BookRide/map.dart';
import 'package:why_taxi_user/Model/driver_model.dart';
import 'package:why_taxi_user/Model/ride_model.dart';
...
import 'package:why_taxi_user/Components/background_image.dart';
                                  ...
                                  child: Card(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          rideList[index].catType == "Auto"||!rideList[index].image.contains('.')?Image.asset(
                                          ...
                                          Text(
                                            ...
                                            style: Theme.of(context)
                                                ...
                                                .copyWith(
                                                    fontSize: 13.5,
                                                    fontWeight:
                                                        FontWeight.bold,color:_currentCar == index ? Colors.white : Colors.black) ,
                                          ),
                                          SizedBox(height: 4),
                                          Text(
                                            // + surge
                                            ...
                                            style: Theme.of(context)
                                                ...
                                                color:_currentCar == index ? Colors.white : Colors.black),
                                          ),
                                        ],
                                      ),
                                    ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  double.parse(rideList[_currentCar].base_fare) >= 1
                      ...
                      : SizedBox(),
                  double.parse(rideList[_currentCar].main_rate_per_km) > double.parse(rideList[_currentCar].rate_per_km)
                      ? Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      text(
                      ...
                      : SizedBox(),
                  if(double.parse(rideList[_currentCar].main_rate_per_km) > double.parse(rideList[_currentCar].rate_per_km))
  ...
  getRides(totalTime) async {
    try {
      Map params = {
        ...
        "drop_city": widget.dropCity.replaceAll(" ", ""),
        "pic_city": widget.pickCity.replaceAll(" ", ""),
        "time": totalTime,
        "location": "Indore",
        "user_id": curUserId,

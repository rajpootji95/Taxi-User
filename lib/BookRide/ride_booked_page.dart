...
class _RideBookedPageState extends State<RideBookedPage>  with WidgetsBindingObserver{
  bool isOpened = false;
                                      ...
                                      child: AnimatedTextKit(
                                        animatedTexts: [
                                          ColorizeAnimatedText(
                                            "${getTranslated(context, "PICKUP_TIME")} - ${((km / 20) * 60).round()} min",
                                ...
                                ? IconButton(
                                    onPressed: () {
                                      ...
                                      final dynamicLinkParams =
                                        ...
                                        link: Uri.parse(
                                            "https://alphataxi.productsalphawizz.com/?${widget.model.bookingId}"),
                                        uriPrefix:
